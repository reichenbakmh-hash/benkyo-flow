...
export const METHOD_CATEGORIES: { id: MethodCategory; label: string; icon: string }[] = [
  { id: "memorisation", label: "Mémorisation", icon: "🧠" },
  { id: "comprehension", label: "Compréhension", icon: "💡" },
  { id: "organisation", label: "Organisation", icon: "🗂️" },
  { id: "revision", label: "Révision", icon: "🔁" },
  { id: "concentration", label: "Concentration", icon: "🎯" },
  { id: "examens", label: "Préparation aux examens", icon: "📝" },
  { id: "prise_de_notes", label: "Prise de notes", icon: "✍️" },
];
