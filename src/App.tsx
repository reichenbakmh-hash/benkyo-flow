...
import type { AmbientSoundId } from "./lib/ambientSound";
...
export default function App() {
  ...
  function updateAmbientSound(id: AmbientSoundId) {
    setSettings((s) => ({ ...s, ambientSoundId: id }));
  }
  function updateAmbientVolume(volume: number) {
    setSettings((s) => ({ ...s, ambientSoundVolume: volume }));
  }
      ...
      >
        ...
        {section === "session" && (
          <PomodoroTimer
            ...
            ambientVolume={settings.ambientSoundVolume}
            onAmbientSoundChange={updateAmbientSound}
