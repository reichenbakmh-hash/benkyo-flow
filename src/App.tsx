...
const CONTACT_LINKS = [
  ...
  { label: "Discord", href: "https://discord.gg/vD7C8Ng4", icon: SiDiscord, tone: "cyan" as const },
];
...
export default function App() {
  ...
  // Ne bloque PAS le refresh (aucune API navigateur ne le permet) : affiche
  // juste la boîte de dialogue native de confirmation quand des données
  // risquent de ne pas être synchronisées avec le cloud (mode invité, ou
  // dernière sauvegarde D1 en échec). L'utilisateur peut toujours choisir
  // de quitter quand même — ce n'est qu'un garde-fou, pas une vraie
  // protection contre la perte de données.
  useEffect(() => {
    function handleBeforeUnload(e: BeforeUnloadEvent) {
      if (authMode === "guest" || !cloudAvailable) {
        e.preventDefault();
        e.returnValue = "";
      }
    }
