    ...
    <>
      ...
      <div className="bf-panel">
        ...
        <div style={{ marginTop: 18, paddingTop: 16, borderTop: "1px solid var(--bf-border)" }}>
          <p style={{ fontSize: 13.5, fontWeight: 600, marginBottom: 4 }}>Image de fond de la barre latérale</p>
          <p style={{ fontSize: 13, color: "var(--bf-text-muted)", marginBottom: 12 }}>
            Choisis une image personnelle (max 1,5 Mo) affichée en fond du menu, teintée avec la couleur du
            thème pour rester lisible.
          </p>
