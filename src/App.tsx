  ...
  if (!isLoggedIn) {
    return (
      <AuthScreen
        ...
        onForgotPassword={(email) => apiForgotPassword(email)}
...
function AuthScreen({
  ...
  async function submit(e: FormEvent) {
    ...
    if (mode === "forgot") {
      ...
      setBusy(true);
      try {
        const res = await onForgotPassword(email.trim().toLowerCase());
      ...
      <div className="bf-auth__card">
        ...
        <p className="bf-auth__subtitle">
          {mode === "guest"
            ...
            : mode === "forgot"
            ? "Indique l'email de ton compte : si un compte existe, on t'envoie un lien de réinitialisation."
