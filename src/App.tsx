      ...
      if (entity === "subject") {
        if (operation === "create") {
          ...
          persistSubject({
            ...
            name: nameArg.trim(),
            color: "teal",
            icon: typeof args.icon === "string" && args.icon.trim() ? args.icon.trim() : "📘",
            createdAt: Date.now(),
          });
                        ...
                        <div key={a.id} className={`bf-action-card status-${a.status}`}>
                          <div className="bf-action-card__desc">
                            <span className="bf-action-card__icon">
                              {a.operation === "create" ? "➕" : a.operation === "delete" ? "🗑️" : "✏️"}
                            </span>
                            {a.description}
                          </div>
                          {a.status === "pending" && (
                          ...
                          {a.status === "done" && <div className="bf-action-card__result">✅ {a.resultLabel}</div>}
                          {a.status === "error" && <div className="bf-action-card__result error">⚠️ {a.resultLabel}</div>}
                          {a.status === "cancelled" && <div className="bf-action-card__result">Ignoré.</div>}
                        </div>
                      ))}
                    </div>
                  )}
